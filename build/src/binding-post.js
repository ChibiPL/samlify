                ...
                case 0:
                    ...
                    if (idpSetting.loginResponseTemplate && idpSetting.loginResponseTemplate.AuthnStatement) {
                        if (idpSetting.loginResponseTemplate.AuthnStatement.tags) {
                            tvalue.AuthnStatement = libsaml_1.default.replaceTagsByValue(idpSetting.loginResponseTemplate.AuthnStatement.content, idpSetting.loginResponseTemplate.AuthnStatement.tags.get());
                        }
                        else {
                    ...
                    if (idpSetting.loginResponseTemplate && customTagReplacement) {
                        ...
                        if (idpSetting.loginResponseTemplate.context !== '') {
                            ...
                            template = customTagReplacement(libsaml_1.default.replaceTagsByValue(libsaml_1.default.defaultLoginResponseTemplate.context, tvalue));
                        }
