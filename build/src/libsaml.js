        ...
        */
        constructSAMLSignature: function (opts) {
            ...
            if (referenceTagXPath) {
                sig.addReference(referenceTagXPath, transformationAlgorithms, getDigestMethod(signatureAlgorithm));
            }
            if (isMessageSigned) {
                sig.addReference(
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (sourceEntitySetting.isAssertionEncrypted) {
                    xmlenc.encrypt(assertions[0].toString(), {
                        ...
                        rsa_pub: Buffer.from(utility_1.default.getPublicKeyPemFromCertificate(targetEntityMetadata.getX509Certificate(certUse.encrypt)).replace(/\r?\n|\r/g, '')),
